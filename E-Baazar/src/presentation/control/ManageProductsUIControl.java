...
public enum ManageProductsUIControl {
	...
	private class MaintainProductsHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			CatalogPres selectedCatalog = ManageProductsData.INSTANCE.getSelectedCatalog();//1.1.2
			if(selectedCatalog != null) {
				ObservableList<ProductPres> list = ManageProductsData.INSTANCE.getProductsList(selectedCatalog);//1.1.3
				maintainProductsWindow.setData(ManageProductsData.INSTANCE.getCatalogList(), list);//1.1.5
			}
