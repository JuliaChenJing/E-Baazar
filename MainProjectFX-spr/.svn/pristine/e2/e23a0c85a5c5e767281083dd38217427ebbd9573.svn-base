...
class DbClassProduct implements DbClass {
	enum Type {LOAD_PROD_TABLE, READ_PRODUCT, READ_PROD_LIST, SAVE_NEW_PROD, DELETE_PROD,UPDATE_PROD};
	...
	private String updateProductQuery = "UPDATE PRODUCT WHERE productid =?";
	...
	private int[] loadProdTableTypes, readProductTypes, readProdListTypes,updateProdTypes, 
	...
	public void updateProduct(Product product) 
		...
		updateProdTypes = new int[]
	        	{Types.INTEGER}; 
	        int count = dataAccessSS.updateWithinTransaction(this);
	}
