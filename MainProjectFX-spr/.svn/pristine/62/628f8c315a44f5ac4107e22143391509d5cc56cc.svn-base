 ...
 *
 */
public class DataAccessSubsystemFacade2 implements DataAccessSubsystem, DataAccessTest {
	...
	public DataAccessSubsystemFacade2() {
    	//do nothing
    }
	
	private static final Logger LOG 
	  = Logger.getLogger(DataAccessSubsystemFacade2.class.getPackage().getName());
