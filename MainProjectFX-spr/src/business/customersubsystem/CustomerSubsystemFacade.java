...
public class CustomerSubsystemFacade implements CustomerSubsystem {
	...
	DbClassAddress dbClassAddress =  (DbClassAddress) SpringContext.getBean(DbClassAddress.class);
	/**
	...
	void loadDefaultShipAddress() throws BackendException {
		...
		try {
			...
			defaultShipAddress =  dbClassAddress.readDefaultShipAddress(customerProfile);
    ...
    //implemented by: Lelam
	void loadDefaultBillAddress() throws BackendException {
		try {
			//DbClassAddress dbClass = new DbClassAddress();
			defaultBillAddress =  dbClassAddress.readDefaultBillAddress(customerProfile);
		} catch (DatabaseException e) {
			throw new BackendException(e);
		}
		// implement
